<?php
	...
	$propo = $_POST['proponents']
	$beneficiary = $_POST['beneficiaries']
	$$accompObj = $_POST['accomplishedObjectives']
	$m = $_POST['monthSelected']
	$d = $_POST['daySelected']
	$y = $_POST['yearSelected']
	$ven = $_POST['venue']
	$timeImple = $_POST['timeImplemented']
	$briefNarra = $_POST['briefNarrative']
	$file = $_POST['fileName']
	$volun = $_POST['volunteers']
	$pos = $_POST['positions']
	$partici = $_POST['participations']
	$group = $_POST['groups']
	$served = $_POST['servedCommunity']
	$timeS = $_POST['timestart']
	$timeE = $_POST['timeend']
	$act = $_POST['activity']
	$per = $_POST['person']
	$particu = $_POST['particulars']
	$amount = $_POST['amounts']
	$totalAmount =  $_POST['total']
	*/
	function generateReport($title,$propo,$beneficiary,$accompObj,$m,$d,$y,$ven,$timeImple,$briefNarra,$file,
	$volun,$pos,$partici,$group,$served,$timeS,$timeE,$act,$per,$particu,$amount,$totalAmount,$user) {
		//PDF FILE
		$activityTitle = $title;
		$proponents = $propo;
		...
		$sheet->setCellValue('A2', $college);
		$sheet->setCellValue('A3', $university);
		$sheet->setCellValue('A4', $city);
		...
		$sheet->fromArray($columnDescriptions,NULL,'E8');
		$sheet->setCellValue('A15', 'Name of Volunteer');
		$sheet->setCellValue('C15', 'Position/Designation');
		$sheet->setCellValue('F15', 'Type of Participation');
		$sheet->setCellValue('I15', 'Group');
	...
	,$_POST['briefNarrative'],$_POST['fileName'],$_POST['volunteers'],$_POST['positions'],$_POST['participations'],$_POST['groups']
	,$_POST['servedCommunity'],$_POST['timestart'],$_POST['timeend'],$_POST['activity'],$_POST['person'],$_POST['particulars']
	,$_POST['amounts'],$_POST['total'],$_SESSION['username']);
?>