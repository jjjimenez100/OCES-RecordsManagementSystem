<?php
    ...
    if(isset($_POST['department']) && isset($_POST['month']) && isset($_POST['day']) && isset($_POST['year']))
    {
    ...
    $sql= "update `tbluser` set `First_Name`='$fname',`Middle_Name`='$mname',`Last_Name`='$lname',`Date_Of_Employment`='$year-$month-$day',`Department`='$dept',`Username`='$username',`Password`='$password' WHERE `UserID`=$empID";
